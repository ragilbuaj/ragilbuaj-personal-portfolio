...
function Contact() {
	return (
		<section className="mt-3 w-full animate-contentAnimation md:flex md:w-11/12 md:flex-col md:items-center md:justify-center">
			...
			<form className="mt-6 grid grid-cols-1 gap-5 md:w-11/12 min-[1440px]:h-full" name="contact" method="post" data-netlify="true" data-netlify-honeypot="bot-field" onSubmit={(e) => e.preventDefault()}>
