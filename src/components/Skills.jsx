	...
	return (
		<section className="flex w-full animate-contentAnimation flex-col items-center justify-center gap-8 md:w-11/12 min-[1440px]:w-8/12">
			...
			<div className="grid w-full grid-cols-3 grid-rows-2 gap-6 font-neue-montreal sm:w-2/3 sm:gap-10 md:gap-8">
				<div className="col-span-2 grid grid-cols-2 items-center rounded-3xl bg-slate-200 p-3 text-base shadow-lg shadow-black grayscale transition ease-in-out hover:scale-105 hover:bg-sky-900 hover:text-white hover:grayscale-0">
				...
				<div className="row-span-2 grid grid-rows-2 items-center justify-items-center rounded-3xl bg-slate-200 p-3 shadow-lg shadow-black grayscale transition ease-in-out hover:scale-105 hover:bg-sky-900 hover:text-white hover:grayscale-0 sm:w-[95px]">
				...
				<div className="col-span-2 grid grid-cols-2 items-center rounded-3xl bg-slate-200 p-3 shadow-lg shadow-black grayscale transition ease-in-out hover:scale-105 hover:bg-sky-900 hover:text-white hover:grayscale-0">
			...
			<div className="grid w-full grid-cols-3 grid-rows-2 gap-6 font-neue-montreal sm:w-2/3 sm:gap-10 md:gap-8">
				<div className="row-span-2 grid grid-rows-2 items-center justify-items-center rounded-3xl bg-slate-200 p-3 shadow-lg shadow-black grayscale transition ease-in-out hover:scale-105 hover:bg-sky-900 hover:text-white hover:grayscale-0 sm:w-[95px] md:justify-self-end">
