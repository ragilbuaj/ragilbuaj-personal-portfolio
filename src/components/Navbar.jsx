...
function Navbar({ activeAnchor }) {
	...
	return (
		<header className="items-center py-3">
			<nav className="flex items-center justify-between border-b-2 pb-2 text-stone-50">
				<div className="flex items-center gap-5">
					<a href="https://ragilbuaj.netlify.app/" className="font-migra text-xl hover:text-orange-200">
						Ragilbuaj.
					</a>
